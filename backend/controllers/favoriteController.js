...
export const getMyFavorites = catchAsyncErrors(async (req, res, next) => {
  // Updated population: Removed 'price'
  const user = await User.findById(req.user._id)
    .populate('favoriteBooks', 'title author description bookFile.url')
...
// Add a book to the user's favorites list (Remains the same)
...
// Remove a book from the user's favorites list (Remains the same)
