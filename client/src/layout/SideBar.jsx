...
// Assuming you have a specific icon for favorites to replace 'catalogIcon' below
    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-col space-y-3 px-6 py-4">
          ...
          {/* 2. Books (ONLY ADMINS) - For Book Management */}
          {isAdmin && (
            <button
              className="w-full py-2 font-medium bg-transparent rounded-md hover:cursor-pointer flex items-center space-x-2"
          ...
          {/* 3. Admin Specific Links (Consolidated) */}
          {isAdmin && (
            <>
              <button
                className="w-full py-2 font-medium bg-transparent rounded-md hover:cursor-pointer flex items-center space-x-2"
          ...
          {/* 4. User Specific Links: Catalog and My Favorites (ONLY USERS) */}
          {isUser && (
            <>
              <button
                className="w-full py-2 font-medium bg-transparent rounded-md hover:cursor-pointer flex items-center space-x-2"
              ...
              >
                <img src={heartIcon || catalogIcon} alt="icon" />
                <span>My Favorites</span>
              </button>
            </>
          )}

          {/* 5. Update Credentials (All Users) */}
          <button
            className="w-full py-2 font-medium bg-transparent rounded-md hover:cursor-pointer flex items-center space-x-2"
